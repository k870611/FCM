...
// TODO (9) Make a new Service in the fcm package that extends from FirebaseMessagingService.
public class SquawkFirebaseMessageService extends FirebaseMessagingService {
    ...
    // TODO (10) As part of the new Service - Override onMessageReceived. This method will
    ...
    // TODO (11) As part of the new Service - If there is message data, get the data using
